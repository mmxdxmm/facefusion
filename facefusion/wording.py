...
WORDING : Dict[str, Any] =\
{
	...
	'help':
	{
		...
		'hair_modifier_model': 'choose the model responsible for modifying the hair',
		'hair_modifier_direction': 'specify the direction in which the hair should be modified',
	...
	'uis':
	{
		...
		'hair_modifier_direction_slider': 'HAIR MODIFIER DIRECTION',
		'hair_modifier_model_dropdown': 'HAIR MODIFIER MODEL',
